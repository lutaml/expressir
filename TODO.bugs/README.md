...
Track all remaining architectural and code-cleanliness work. Each file
describes one focused change.
...
**26 of 30 TODOs implemented.** 4 remain deferred (14, 16, 24, 28-29).
...
| [04](04-formatter-public-send-dispatch.md) | P1 | done | Add registration-time guard |
...
| [14](14-model-formatting-leak.md) | P1 | deferred | Model layer embeds EXPRESS formatting |
| [15](15-expression-children-macro.md) | P1 | done | `child_attributes` macro |
| [16](16-pretty-formatter-duplication.md) | P1 | deferred | PrettyFormatter duplicates declarations |
...
| [24](24-streaming-builder-complexity.md) | P3 | deferred | Split `convert_ast_format` |
...
| [29](29-validate-ascii-god-class.md) | P2 | deferred | ValidateAscii 604-line god class |

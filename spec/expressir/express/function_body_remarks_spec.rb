...
RSpec.describe "function body tail remarks" do
  ...
  it "emits no remarks with no_remarks: true" do
    bare = Expressir::Express::Formatter.new(no_remarks: true).format(repo)

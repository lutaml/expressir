require "reeper/express/interface_specification"
    ...
    class Repository
      ...
      def parse
        ...
        @schemas = document.xpath("//express/schema").map do |schema|
          Reeper::Express::SchemaDefinition.new(schema)
        end
          ...
          if !content.selectitems.nil?
            ...
            select_temp.each do |name|
              ...
              if thetype
                ...
                Reeper.ui.error("ERROR : SELECT Item Not Found : " + name)
              end
            end
          end
        end
        ...
        if content.is_a?(Express::GlobalRule)
          ...
          ent_temp.each do |name|
            ...
            if thetype
              ...
              Reeper.ui.error("ERROR : Rule Entity Not Found : " + name)
            end
          end
        end
      end

...
RSpec.describe Expressir::Express::PrettyFormatter do
  ...
  describe "#format_constant_block" do
    ...
    it "formats single constant" do
      ...
      allow(constant).to receive_messages(type: type, expression: expression)
    ...
    it "aligns multiple constants with different name lengths" do
      ...
      allow(const1).to receive_messages(type: type1, expression: expr1)
      allow(const2).to receive_messages(type: type2, expression: expr2)

require "expressr/express/interface_specification"
    ...
    class Repository
      ...
      def parse
        ...
        @schemas = document.xpath("//express/schema").map do |schema|
          Expressr::Express::SchemaDefinition.new(schema)
        end
          ...
          if !content.selectitems.nil?
            ...
            select_temp.each do |name|
              ...
              if thetype
                ...
                Expressr.ui.error("ERROR : SELECT Item Not Found : " + name)
              end
            end
          end
        end
        ...
        if content.is_a?(Express::GlobalRule)
          ...
          ent_temp.each do |name|
            ...
            if thetype
              ...
              Expressr.ui.error("ERROR : Rule Entity Not Found : " + name)
            end
          end
        end
      end

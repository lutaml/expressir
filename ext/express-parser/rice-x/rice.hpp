...
namespace Rice::detail
{
  ...
  private:
    ...
    inline static std::unordered_map<size_t, size_t> methodWCheck = {};
  };
} 
...
//    size_t check = methodWCheck[key(klass, id)];
...
//    methodWCheck[key(klass, id)] = std::any_cast<size_t>(data);
  }
}
...
// [maxirmx 1]    
    ...
    VALUE nf = wrapper->operator()(argc, argv, self);
    return nf;
  }
